package com.smile.util.mouse.paint;
...
public class DrawMouseEvent {
    ...
    private static DrawMouseEvent instance = null;

    private DrawMouseEvent() {
        Client.getInstance().setDrawMouse(false);
    }
    public static DrawMouseEvent getInstance() {
        if (instance == null) {
            instance = new DrawMouseEvent();
        }
        return instance;
    }
